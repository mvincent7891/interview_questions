...
// that turns a string into an int
...
// 7.2: Accept a string, and two bases. Convert the string from the
// first base to the second. You may want to write some helper methods.

export const baseConverter = (str, b1, b2) => {
